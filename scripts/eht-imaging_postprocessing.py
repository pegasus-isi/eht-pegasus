...
parser = argparse.ArgumentParser(
    description="Script to convert EHT_Difmap fits files to pdf images"
)
...
parser.add_argument(
    ...
    "--blur",
    default=False,
    help="apply Gaussian blur to image",
    action="store_true",
)
parser.add_argument(
    "-u",
    "--afmhot10us",
    default=False,
    help="use the afmhot_10us colormap",
    action="store_true",
)
parser.add_argument(
    "-t",
    "--notitle",
    default=False,
    help="display with no title or padding",
    action="store_true",
)
parser.add_argument(
    "-a",
...
cmap = (
    ...
    if (args.afmhot10us or args.all)
    else "afmhot"
)
